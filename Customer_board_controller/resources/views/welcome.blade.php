...
<section class="jumbotron text-center">
    <div class="container mt-3">
        ...
        <h3 class="lead text-dark">This is a simple laravel application made by Gabriel Souza B. Doudement
            <a href="https://www.linkedin.com/in/gabrielsouzabd/"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-linkedin" viewBox="0 0 16 16">
                ...
                </svg></a></br>for the purpose of practicing and learning</h3>
        <p>
            <a href="{{route('login.index')}}" class="btn btn-primary my-2">Login</a>
            <a href="{{route('users.create')}}" class="btn btn-secondary my-2">Cadastro</a>
        </p>
    </div>
</section>
</x-layout>
